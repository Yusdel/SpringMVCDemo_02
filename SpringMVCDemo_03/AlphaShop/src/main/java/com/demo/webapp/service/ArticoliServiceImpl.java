...
/*
 * Note. Business Logics are applied at this level. 
 * (ex. If we need to apply a discount we do it at this level, not in
 * the Persistence Layer, not in the Controller!)   
 */
